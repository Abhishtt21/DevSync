...
const Chats: React.FC<chatProps> = ({ chats, addChat }) => {
  ...
  return (
    <Flex direction="column" p="4" bg="bg-orange-500" gap='40px' color="text-gray-800" h="80vh">
    <Box
      flex="1"
      overflowY="auto"
      css={{
    ...
    >
      {chats.map((chat, index) => (
        <Box key={index} p="3" bg="bg-gray-800" borderRadius="md" mb="3">
    ...
    <Flex>
      <Input
        ...
        color="text-gray-800"
        border="none"
        _placeholder={{ color: "text-blue-600" }}
        flex="1"
      />
      <IconButton
